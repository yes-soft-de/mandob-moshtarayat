...
import '../module_captain/captains_module.dart' as _i159;
...
import '../module_captain/ui/screen/in_active_captains_screen.dart' as _i107;
...
import '../module_clients/state_manager/captain_profile_state_manager.dart'
    as _i99;
import '../module_clients/ui/screen/clients_list_screen.dart' as _i101;
import '../module_clients/ui/screen/clients_profile_screen.dart' as _i142;
import '../module_company/company_module.dart' as _i161;
...
import '../module_distributor/module_captain/distros_module.dart' as _i160;
import '../module_distributor/module_captain/manager/distributors_manager.dart'
    as _i55;
import '../module_distributor/module_captain/repository/distributor_repository.dart'
    as _i24;
import '../module_distributor/module_captain/service/distributer_service.dart'
    as _i104;
import '../module_distributor/module_captain/state_manager/captain_balance_state_manager.dart'
    as _i89;
import '../module_distributor/module_captain/state_manager/captain_captains_payment_list_state_manager.dart'
    as _i95;
import '../module_distributor/module_captain/state_manager/captain_profile_state_manager.dart'
    as _i92;
import '../module_distributor/module_captain/state_manager/distros_list.dart'
    as _i105;
import '../module_distributor/module_captain/state_manager/in_active_distro_state_manager.dart'
    as _i63;
import '../module_distributor/module_captain/ui/screen/captain_balance_screen.dart'
    as _i133;
import '../module_distributor/module_captain/ui/screen/captain_profile_screen.dart'
    as _i137;
import '../module_distributor/module_captain/ui/screen/catpains_payment_screen.dart'
    as _i139;
import '../module_distributor/module_captain/ui/screen/distors_list_screen.dart'
    as _i146;
import '../module_distributor/module_captain/ui/screen/in_active_distros_screen.dart'
    as _i108;
...
import '../module_localization/service/localization_service/localization_service.dart'
    as _i7;
import '../module_logs/logs_module.dart' as _i148;
...
import '../module_main/sceen/home_screen.dart' as _i106;
import '../module_main/sceen/main_screen.dart' as _i110;
...
import '../module_orders/orders_module.dart' as _i153;
...
import '../module_orders/state_manager/captains_from_state_manager.dart'
    as _i68;
import '../module_orders/state_manager/my_orders_state_manager.dart' as _i111;
...
import '../module_orders/state_manager/orders_without_pending_state_manager.dart'
    as _i115;
import '../module_orders/ui/screen/my_orders_screen.dart' as _i117;
import '../module_orders/ui/screen/OngoingOrdersScreen.dart' as _i150;
import '../module_orders/ui/screen/order_accounts_screen.dart' as _i116;
import '../module_orders/ui/screen/order_details_screen.dart' as _i151;
import '../module_orders/ui/screen/order_timeline_screen.dart' as _i152;
import '../module_orders/ui/screen/orders_without_pending_screen.dart' as _i118;
...
import '../module_payments/state_manager/payments_to_state_manager.dart'
    as _i72;
import '../module_payments/ui/screen/paymen_from_captain_screen.dart' as _i154;
...
import '../module_reports/report_module.dart' as _i122;
...
import '../module_reports/ui/screen/clients_reports_screen.dart' as _i100;
import '../module_reports/ui/screen/products_reports_screen.dart' as _i121;
...
import '../module_stores/ui/screen/stores_inactive_screen.dart' as _i157;
...
import '../module_upload/service/image_upload/image_upload_service.dart'
    as _i27;
import '../utils/global/global_state_manager.dart' as _i163;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i63.InActiveDistributorsStateManager>(
      () => _i63.InActiveDistributorsStateManager(get<_i42.CaptainsService>()));
  ...
  gh.factory<_i82.StoresFilterStateManager>(
      () => _i82.StoresFilterStateManager(get<_i57.FiltersService>()));
  ...
  gh.factory<_i90.CaptainFilterStateManager>(
      () => _i90.CaptainFilterStateManager(get<_i57.FiltersService>()));
  ...
  gh.factory<_i100.ClientsReportScreen>(
      () => _i100.ClientsReportScreen(get<_i50.ClientsReportStateManager>()));
  gh.factory<_i101.ClientsScreen>(
      () => _i101.ClientsScreen(get<_i52.ClientsStateManager>()));
  gh.factory<_i102.CompanyFinanceStateManager>(() =>
      _i102.CompanyFinanceStateManager(
          get<_i18.AuthService>(), get<_i54.CompanyService>()));
  gh.factory<_i103.CompanyProfileStateManager>(() =>
      _i103.CompanyProfileStateManager(
          get<_i18.AuthService>(), get<_i54.CompanyService>()));
  gh.factory<_i104.DistributerService>(
      () => _i104.DistributerService(get<_i55.DistributorManager>()));
  gh.factory<_i105.DistrosStateManager>(
      () => _i105.DistrosStateManager(get<_i104.DistributerService>()));
  gh.factory<_i106.HomeScreen>(
      () => _i106.HomeScreen(get<_i61.HomeStateManager>()));
  gh.factory<_i107.InActiveCaptainsScreen>(() =>
      _i107.InActiveCaptainsScreen(get<_i62.InActiveCaptainsStateManager>()));
  gh.factory<_i108.InActiveDistributorsScreen>(() =>
      _i108.InActiveDistributorsScreen(
          get<_i63.InActiveDistributorsStateManager>()));
  gh.factory<_i109.LevelTowCategoriesScreen>(() =>
      _i109.LevelTowCategoriesScreen(get<_i73.ProductsCategoryStateManager>(),
          get<_i7.LocalizationService>()));
  gh.factory<_i110.MainScreen>(() => _i110.MainScreen(get<_i106.HomeScreen>()));
  gh.factory<_i111.MyOrdersStateManager>(() => _i111.MyOrdersStateManager(
      get<_i69.OrdersService>(), get<_i18.AuthService>()));
  gh.factory<_i112.OnGoingOrdersStateManager>(() =>
      _i112.OnGoingOrdersStateManager(
          get<_i69.OrdersService>(), get<_i18.AuthService>()));
  gh.factory<_i113.OrderDetailsStateManager>(
      () => _i113.OrderDetailsStateManager(get<_i69.OrdersService>()));
  gh.factory<_i114.OrderTimeLineStateManager>(
      () => _i114.OrderTimeLineStateManager(get<_i69.OrdersService>()));
  gh.factory<_i115.OrderWithoutPendingStateManager>(() =>
      _i115.OrderWithoutPendingStateManager(
          get<_i69.OrdersService>(), get<_i18.AuthService>()));
  gh.factory<_i116.OrdersAccountScreen>(
      () => _i116.OrdersAccountScreen(get<_i68.OrdersAccountStateManager>()));
  gh.factory<_i117.OrdersScreen>(
      () => _i117.OrdersScreen(get<_i111.MyOrdersStateManager>()));
  gh.factory<_i118.OrdersWithoutPendingScreen>(() =>
      _i118.OrdersWithoutPendingScreen(
          get<_i115.OrderWithoutPendingStateManager>()));
  gh.factory<_i119.PaymentsFromCaptainStateManager>(() =>
      _i119.PaymentsFromCaptainStateManager(
          get<_i42.CaptainsService>(), get<_i71.PaymentsService>()));
  gh.factory<_i120.PaymentsToCaptainScreen>(() =>
      _i120.PaymentsToCaptainScreen(get<_i72.PaymentsToCaptainStateManager>()));
  gh.factory<_i121.ProductsReportScreen>(
      () => _i121.ProductsReportScreen(get<_i74.ProductsReportStateManager>()));
  gh.factory<_i122.ReportsModule>(() => _i122.ReportsModule(
      get<_i121.ProductsReportScreen>(),
      get<_i83.StoresReportScreen>(),
      get<_i96.CaptainsReportScreen>(),
      get<_i100.ClientsReportScreen>()));
  ...
  gh.factory<_i125.StoreLogsScreen>(
      () => _i125.StoreLogsScreen(get<_i79.StoreLogsStateManager>()));
  gh.factory<_i126.StoreProductScreen>(
      () => _i126.StoreProductScreen(get<_i81.StoreProductsStateManager>()));
  gh.factory<_i127.StoreProfileStateManager>(
      () => _i127.StoreProfileStateManager(get<_i84.StoresService>()));
  gh.factory<_i128.StoresFilterScreen>(
      () => _i128.StoresFilterScreen(get<_i82.StoresFilterStateManager>()));
  ...
  gh.factory<_i130.StoresScreen>(
      () => _i130.StoresScreen(get<_i85.StoresStateManager>()));
  ...
  gh.factory<_i134.CaptainFilterScreen>(
      () => _i134.CaptainFilterScreen(get<_i90.CaptainFilterStateManager>()));
  gh.factory<_i135.CaptainLogsScreen>(
      () => _i135.CaptainLogsScreen(get<_i91.CaptainLogsStateManager>()));
  gh.factory<_i136.CaptainProfileScreen>(
      () => _i136.CaptainProfileScreen(get<_i93.CaptainProfileStateManager>()));
  gh.factory<_i137.CaptainProfileScreen>(
      () => _i137.CaptainProfileScreen(get<_i93.CaptainProfileStateManager>()));
  gh.factory<_i138.CaptainsPaymentsScreen>(() =>
      _i138.CaptainsPaymentsScreen(get<_i94.CaptainsPaymentsStateManager>()));
  gh.factory<_i139.CaptainsPaymentsScreen>(() =>
      _i139.CaptainsPaymentsScreen(get<_i94.CaptainsPaymentsStateManager>()));
  gh.factory<_i140.CategoriesModule>(() => _i140.CategoriesModule(
      get<_i124.StoreCategoriesScreen>(),
      get<_i109.LevelTowCategoriesScreen>(),
      get<_i126.StoreProductScreen>(),
      get<_i131.SubCategoriesScreen>()));
  gh.factory<_i141.ChatModule>(
      () => _i141.ChatModule(get<_i98.ChatPage>(), get<_i18.AuthService>()));
  gh.factory<_i142.ClientProfileScreen>(
      () => _i142.ClientProfileScreen(get<_i99.ClientProfileStateManager>()));
  gh.factory<_i143.ClientsModule>(() => _i143.ClientsModule(
      get<_i142.ClientProfileScreen>(), get<_i101.ClientsScreen>()));
  gh.factory<_i144.CompanyFinanceScreen>(() =>
      _i144.CompanyFinanceScreen(get<_i102.CompanyFinanceStateManager>()));
  gh.factory<_i145.CompanyProfileScreen>(() =>
      _i145.CompanyProfileScreen(get<_i103.CompanyProfileStateManager>()));
  gh.factory<_i146.DistrosScreen>(
      () => _i146.DistrosScreen(get<_i105.DistrosStateManager>()));
  gh.factory<_i147.FiltersModule>(() => _i147.FiltersModule(
      get<_i134.CaptainFilterScreen>(), get<_i128.StoresFilterScreen>()));
  gh.factory<_i148.LogsModule>(() => _i148.LogsModule(
      get<_i135.CaptainLogsScreen>(), get<_i125.StoreLogsScreen>()));
  gh.factory<_i149.MainModule>(
      () => _i149.MainModule(get<_i110.MainScreen>(), get<_i106.HomeScreen>()));
  gh.factory<_i150.OnGoingOrdersScreen>(
      () => _i150.OnGoingOrdersScreen(get<_i112.OnGoingOrdersStateManager>()));
  gh.factory<_i151.OrderDetailsScreen>(
      () => _i151.OrderDetailsScreen(get<_i113.OrderDetailsStateManager>()));
  gh.factory<_i152.OrderTimLineScreen>(
      () => _i152.OrderTimLineScreen(get<_i114.OrderTimeLineStateManager>()));
  gh.factory<_i153.OrdersModule>(() => _i153.OrdersModule(
      get<_i117.OrdersScreen>(),
      get<_i151.OrderDetailsScreen>(),
      get<_i150.OnGoingOrdersScreen>(),
      get<_i152.OrderTimLineScreen>(),
      get<_i118.OrdersWithoutPendingScreen>(),
      get<_i116.OrdersAccountScreen>()));
  gh.factory<_i154.PaymentsFromCaptainScreen>(() =>
      _i154.PaymentsFromCaptainScreen(
          get<_i119.PaymentsFromCaptainStateManager>()));
  gh.factory<_i155.PaymentsModule>(() => _i155.PaymentsModule(
      get<_i154.PaymentsFromCaptainScreen>(),
      get<_i120.PaymentsToCaptainScreen>()));
  gh.factory<_i156.StoreInfoScreen>(
      () => _i156.StoreInfoScreen(get<_i127.StoreProfileStateManager>()));
  gh.factory<_i157.StoresInActiveScreen>(() =>
      _i157.StoresInActiveScreen(get<_i129.StoresInActiveStateManager>()));
  gh.factory<_i158.StoresModule>(() => _i158.StoresModule(
      get<_i130.StoresScreen>(),
      get<_i156.StoreInfoScreen>(),
      get<_i157.StoresInActiveScreen>()));
  gh.factory<_i159.CaptainsModule>(() => _i159.CaptainsModule(
      get<_i107.InActiveCaptainsScreen>(),
      get<_i136.CaptainProfileScreen>(),
      get<_i132.CaptainBalanceScreen>(),
      get<_i138.CaptainsPaymentsScreen>(),
      get<_i97.CaptainsScreen>()));
  gh.factory<_i160.DistributorsModule>(() => _i160.DistributorsModule(
      get<_i107.InActiveCaptainsScreen>(),
      get<_i136.CaptainProfileScreen>(),
      get<_i132.CaptainBalanceScreen>(),
      get<_i138.CaptainsPaymentsScreen>(),
      get<_i97.CaptainsScreen>()));
  gh.factory<_i161.CompanyModule>(() => _i161.CompanyModule(
      get<_i145.CompanyProfileScreen>(), get<_i144.CompanyFinanceScreen>()));
  gh.factory<_i162.MyApp>(() => _i162.MyApp(
      get<_i13.AppThemeDataService>(),
      get<_i7.LocalizationService>(),
      get<_i58.FireNotificationService>(),
      ...
      get<_i123.SettingsModule>(),
      get<_i149.MainModule>(),
      get<_i140.CategoriesModule>(),
      get<_i158.StoresModule>(),
      get<_i159.CaptainsModule>(),
      get<_i161.CompanyModule>(),
      get<_i153.OrdersModule>(),
      get<_i155.PaymentsModule>(),
      get<_i147.FiltersModule>(),
      get<_i148.LogsModule>()));
  gh.singleton<_i163.GlobalStateManager>(_i163.GlobalStateManager(
