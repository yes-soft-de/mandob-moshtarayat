...
@injectable
class UpdateSubCategoriesStateManager {
  ...
  UpdateSubCategoriesStateManager(
      this._categoriesService, this._authService, this._uploadService);

  void getSubCategory(UpdateSubCategoryScreenState screenState, String id) {
    ...
    _categoriesService.getProductCategory(id).then((value) {
      if (value.hasError) {
        ...
        _stateSubject.add(SubCategoryLoaded(screenState));
      }
    });
  }
