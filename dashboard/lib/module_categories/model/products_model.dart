...
class ProductsModel extends DataModel{
  ...
  ProductsModel({required this.id,required this.storeOwnerProfileID,required this.productName,required this.productImage,required this.productPrice,
    required  this.discount,
    required this.storeProductCategoryID ,required this.commission});
