...
import 'package:mandob_moshtarayat/module_init/ui/state/init_account_captain_init_profile/init_account_first_loading.dart';
import 'package:mandob_moshtarayat/module_init/ui/state/init_account_captain_profile_created/init_account_captain_profile_created.dart';
...
class InitAccountStateManager {
  ...
  void submitProfile (CreateStoreRequest request,InitAccountScreenState screenState) {
    _stateSubject.add(
