...
import 'package:mandob_moshtarayat_captain/module_chat/presistance/chat_hive_helper.dart';
import 'package:mandob_moshtarayat_captain/module_chat/state_manager/chat_state_manager.dart';
import 'package:mandob_moshtarayat_captain/module_chat/ui/screens/chat_state/empty_state.dart';
import 'package:mandob_moshtarayat_captain/module_chat/ui/screens/chat_state/loading_state.dart';
import 'package:mandob_moshtarayat_captain/module_chat/ui/widget/chat_bubble/chat_bubble.dart';
import 'package:mandob_moshtarayat_captain/module_chat/ui/widget/chat_writer/chat_writer.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          appBar: CustomTwaslnaAppBar.appBar(context, title: S.current.chatRoom,
              onTap: () {
            int remove = 0;
            if (newMessagesWidgetExist()) {
              remove = 1;
