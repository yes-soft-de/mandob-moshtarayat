...
import '../main.dart' as _i121;
import '../module_account/account_module.dart' as _i120;
...
import '../module_account/ui/screen/favourite_screen.dart' as _i106;
import '../module_account/ui/screen/presonal_data_screen.dart' as _i114;
...
import '../module_orders/orders_module.dart' as _i113;
...
import '../module_orders/ui/screen/client_order_screen.dart' as _i105;
import '../module_orders/ui/screen/my_orders_screen.dart' as _i109;
import '../module_orders/ui/screen/order_details_screen.dart' as _i110;
import '../module_orders/ui/screen/order_logs_screen.dart' as _i111;
import '../module_orders/ui/screen/order_status_screen.dart' as _i112;
...
import '../module_our_services/services_module.dart' as _i118;
...
import '../module_our_services/state_manager/services_state_manager.dart'
    as _i74;
import '../module_our_services/ui/screen/private_order_screen.dart' as _i115;
...
import '../module_products/products_module.dart' as _i117;
...
import '../module_products/state_manager/cart_state_manager.dart' as _i85;
import '../module_products/state_manager/products_state_manager.dart' as _i97;
import '../module_products/ui/screen/cart_screen.dart' as _i103;
import '../module_products/ui/screen/products_details_screen.dart' as _i116;
...
import '../module_stores/state_manager/store_products_state_manager.dart'
    as _i80;
import '../module_stores/store_module.dart' as _i119;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i7.FavoriteHiveHelper>(() => _i7.FavoriteHiveHelper());
  ...
  gh.factory<_i85.CartStateManager>(
      () => _i85.CartStateManager(get<_i67.ProductsService>()));
  ...
  gh.factory<_i89.HomeScreen>(
      () => _i89.HomeScreen(get<_i59.HomeStateManager>()));
  gh.factory<_i90.MyNotificationsScreen>(() =>
      _i90.MyNotificationsScreen(get<_i63.MyNotificationsStateManager>()));
  ...
  gh.factory<_i93.OrderLogsStateManager>(
      () => _i93.OrderLogsStateManager(get<_i65.OrdersService>()));
  ...
  gh.factory<_i97.ProductDetailsStateManager>(
      () => _i97.ProductDetailsStateManager(get<_i67.ProductsService>()));
  gh.factory<_i98.SearchModule>(
      () => _i98.SearchModule(get<_i71.SearchScreen>()));
  gh.factory<_i99.SendItScreen>(
      () => _i99.SendItScreen(get<_i74.ServicesStateManager>()));
  ...
  gh.factory<_i102.AccountScreen>(
      () => _i102.AccountScreen(get<_i83.AccountStateManager>()));
  gh.factory<_i103.CartScreen>(
      () => _i103.CartScreen(get<_i85.CartStateManager>()));
  gh.factory<_i104.ChatModule>(
      () => _i104.ChatModule(get<_i86.ChatPage>(), get<_i30.AuthService>()));
  gh.factory<_i105.ClientOrderScreen>(
      () => _i105.ClientOrderScreen(get<_i87.ClientOrderStateManager>()));
  gh.factory<_i106.FavouritScreen>(
      () => _i106.FavouritScreen(get<_i88.FavouriteStateManager>()));
  gh.factory<_i107.HomeModule>(() => _i107.HomeModule(get<_i89.HomeScreen>()));
  gh.factory<_i108.MyNotificationsModule>(
      () => _i108.MyNotificationsModule(get<_i90.MyNotificationsScreen>()));
  gh.factory<_i109.MyOrdersScreen>(
      () => _i109.MyOrdersScreen(get<_i91.MyOrdersStateManager>()));
  gh.factory<_i110.OrderDetailsScreen>(
      () => _i110.OrderDetailsScreen(get<_i92.OrderDetailsStateManager>()));
  gh.factory<_i111.OrderLogsScreen>(
      () => _i111.OrderLogsScreen(get<_i93.OrderLogsStateManager>()));
  gh.factory<_i112.OrderStatusScreen>(
      () => _i112.OrderStatusScreen(get<_i94.OrderStatusStateManager>()));
  gh.factory<_i113.OrdersModule>(() => _i113.OrdersModule(
      get<_i109.MyOrdersScreen>(),
      get<_i110.OrderDetailsScreen>(),
      get<_i112.OrderStatusScreen>(),
      get<_i105.ClientOrderScreen>(),
      get<_i111.OrderLogsScreen>()));
  gh.factory<_i114.PersonalDataScreen>(
      () => _i114.PersonalDataScreen(get<_i95.PersonalDataStateManager>()));
  gh.factory<_i115.PrivateOrderScreen>(
      () => _i115.PrivateOrderScreen(get<_i96.PrivateOrderStateManager>()));
  gh.factory<_i116.ProductDetailsScreen>(
      () => _i116.ProductDetailsScreen(get<_i97.ProductDetailsStateManager>()));
  gh.factory<_i117.ProductsModule>(() => _i117.ProductsModule(
      get<_i116.ProductDetailsScreen>(), get<_i103.CartScreen>()));
  gh.factory<_i118.ServicesModule>(() => _i118.ServicesModule(
      get<_i99.SendItScreen>(), get<_i115.PrivateOrderScreen>()));
  gh.factory<_i119.StoreModule>(() => _i119.StoreModule(
      get<_i77.StoreListScreen>(), get<_i101.StoreProductsScreen>()));
  gh.factory<_i120.AccountModule>(() => _i120.AccountModule(
      get<_i102.AccountScreen>(),
      get<_i114.PersonalDataScreen>(),
      get<_i3.AboutScreen>(),
      get<_i16.PrivecyPolicy>(),
      get<_i18.TermsOfUse>()));
  gh.factory<_i121.MyApp>(() => _i121.MyApp(
      get<_i22.AppThemeDataService>(),
      get<_i12.LocalizationService>(),
      get<_i55.FireNotificationService>(),
      ...
      get<_i104.ChatModule>(),
      get<_i100.SettingsModule>(),
      get<_i25.MainModule>(),
      get<_i113.OrdersModule>(),
      get<_i98.SearchModule>(),
      get<_i120.AccountModule>(),
      get<_i118.ServicesModule>(),
      get<_i119.StoreModule>(),
      get<_i108.MyNotificationsModule>(),
      get<_i117.ProductsModule>()));
  return get;
}
