...
import '../module_account/state_manager/presonal_data_state_manager.dart'
    as _i82;
import '../module_account/ui/screen/account_screen.dart' as _i89;
import '../module_account/ui/screen/presonal_data_screen.dart' as _i98;
...
import '../module_orders/ui/screen/client_order_screen.dart' as _i91;
import '../module_orders/ui/screen/my_orders_screen.dart' as _i93;
import '../module_orders/ui/screen/order_details_screen.dart' as _i94;
import '../module_orders/ui/screen/order_logs_screen.dart' as _i95;
import '../module_orders/ui/screen/order_status_screen.dart' as _i96;
...
import '../module_our_services/state_manager/services_state_manager.dart'
    as _i63;
import '../module_our_services/ui/screen/private_order_screen.dart' as _i99;
import '../module_our_services/ui/screen/send_it_screen.dart' as _i86;
import '../module_products/manager/products_manager.dart' as _i57;
import '../module_products/products_module.dart' as _i101;
...
import '../module_products/state_manager/products_state_manager.dart' as _i84;
import '../module_products/ui/screen/cart_screen.dart' as _i4;
import '../module_products/ui/screen/products_details_screen.dart' as _i100;
...
import '../module_stores/ui/screen/store_products_screen.dart' as _i88;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i34.ProductsRepository>(() =>
      _i34.ProductsRepository(get<_i15.ApiClient>(), get<_i24.AuthService>()));
  ...
  gh.factory<_i83.PrivateOrderStateManager>(() => _i83.PrivateOrderStateManager(
      get<_i62.ServicesService>(), get<_i24.AuthService>()));
  gh.factory<_i84.ProductDetailsStateManager>(
      () => _i84.ProductDetailsStateManager(get<_i58.ProductsService>()));
  gh.factory<_i85.SearchModule>(
      () => _i85.SearchModule(get<_i60.SearchScreen>()));
  gh.factory<_i86.SendItScreen>(
      () => _i86.SendItScreen(get<_i63.ServicesStateManager>()));
  gh.factory<_i87.SettingsModule>(
      () => _i87.SettingsModule(get<_i64.SettingsScreen>()));
  gh.factory<_i88.StoreProductsScreen>(() => _i88.StoreProductsScreen(
      get<_i69.StoreProductsStateManager>(), get<_i24.AuthService>()));
  gh.factory<_i89.AccountScreen>(
      () => _i89.AccountScreen(get<_i72.AccountStateManager>()));
  gh.factory<_i90.ChatModule>(
      () => _i90.ChatModule(get<_i74.ChatPage>(), get<_i24.AuthService>()));
  gh.factory<_i91.ClientOrderScreen>(
      () => _i91.ClientOrderScreen(get<_i75.ClientOrderStateManager>()));
  gh.factory<_i92.MyNotificationsModule>(
      () => _i92.MyNotificationsModule(get<_i77.MyNotificationsScreen>()));
  gh.factory<_i93.MyOrdersScreen>(
      () => _i93.MyOrdersScreen(get<_i78.MyOrdersStateManager>()));
  gh.factory<_i94.OrderDetailsScreen>(
      () => _i94.OrderDetailsScreen(get<_i79.OrderDetailsStateManager>()));
  gh.factory<_i95.OrderLogsScreen>(
      () => _i95.OrderLogsScreen(get<_i80.OrderLogsStateManager>()));
  gh.factory<_i96.OrderStatusScreen>(
      () => _i96.OrderStatusScreen(get<_i81.OrderStatusStateManager>()));
  gh.factory<_i97.OrdersModule>(() => _i97.OrdersModule(
      get<_i93.MyOrdersScreen>(),
      get<_i94.OrderDetailsScreen>(),
      get<_i96.OrderStatusScreen>(),
      get<_i91.ClientOrderScreen>(),
      get<_i95.OrderLogsScreen>()));
  gh.factory<_i98.PersonalDataScreen>(
      () => _i98.PersonalDataScreen(get<_i82.PersonalDataStateManager>()));
  gh.factory<_i99.PrivateOrderScreen>(
      () => _i99.PrivateOrderScreen(get<_i83.PrivateOrderStateManager>()));
  gh.factory<_i100.ProductDetailsScreen>(
      () => _i100.ProductDetailsScreen(get<_i84.ProductDetailsStateManager>()));
  gh.factory<_i101.ProductsModule>(() => _i101.ProductsModule(
      get<_i100.ProductDetailsScreen>(), get<_i4.CartScreen>()));
  gh.factory<_i102.ServicesModule>(() => _i102.ServicesModule(
      get<_i86.SendItScreen>(), get<_i99.PrivateOrderScreen>()));
  gh.factory<_i103.StoreModule>(() => _i103.StoreModule(
      get<_i66.StoreListScreen>(), get<_i88.StoreProductsScreen>()));
  gh.factory<_i104.AccountModule>(() => _i104.AccountModule(
      get<_i89.AccountScreen>(), get<_i98.PersonalDataScreen>()));
