...
class InitAccountService {
  ...
  Future<ProfilePostState> createMandobProfile(CreateMandobRequest request) async {
    CreateCaptainProfileResponse? clientOrderResponse = await _manager.createMandobProfile(request);
